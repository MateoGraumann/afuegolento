...
urlpatterns = [
    ...
    path("orders/<int:pk>/status/", OrderChangeStatusView.as_view(), name="order_change_status"),
    ...
    path("pizzas/<int:pizza_id>/recipes/new/", RecipeItemCreateView.as_view(), name="pizza_recipe_create"),
